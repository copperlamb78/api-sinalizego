...
| 🧪 **Suíte de Testes Completa** | 392 testes unitários automatizados (36 suítes) cobrindo 100% dos módulos, controllers, services, helpers, regras financeiras, emissão e webhooks de NFS-e, No-Show com travas temporais, Escrow Hold, saques e permissões |
...
O projeto possui **100% de cobertura de controladores e regras críticas de serviço**, totalizando **36 suítes de teste e 392 testes unitários automatizados**.
